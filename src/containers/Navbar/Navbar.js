...
import { LIST_PATH, ACCOUNT_PATH, CUSTOMER_LIST_PATH,
        AGENCIES_PATH, POLICIES_PATH, LOGIN_PATH, SIGNUP_PATH } from 'constants'
...
export default class Navbar extends Component {
  ...
  render () {
        ...
        <div className={classes.avatar}>
          ...
          <div className={classes['avatar-text']}>
            <span className={`${classes['avatar-text-name']} hidden-mobile`}>
              {
                account && account.displayName ? account.displayName : localization.user
              }
            </span>
    ...
    const rightMenu = authExists ? (
      ...
      >
        <MenuItem
          primaryText={localization.customers}
          onTouchTap={() => this.context.router.push(CUSTOMER_LIST_PATH)}
        />
        <MenuItem
          primaryText={localization.agencies}
          onTouchTap={() => this.context.router.push(AGENCIES_PATH)}
        />
        <MenuItem
          primaryText={localization.policies}
          onTouchTap={() => this.context.router.push(POLICIES_PATH)}
        />
        <MenuItem
          primaryText='Account'
        ...
        />
        <MenuItem
          primaryText={localization.signout}
